...
Il n'y a pas de viscosité, car fluide parfait.
	...
	\item[$\clubsuit$] On retrouve facilement le sens des vents avec le gradient moyen de pression.
	
	\item[$\clubsuit$] On peut estimer le gradient de pression grâce à $\vec{grad}(p)=-\frac{1}{R_T}\frac{dP}{d\lambda}\vec{e_x}$.
